    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Colonne 1 */}
          <div>
            <h3 className="text-xl font-bold mb-4">Ticket Time</h3>
            <p className="text-gray-400 mb-4">
              Votre destination pour découvrir et acheter des billets pour les meilleurs événements au Maroc.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/events" className="text-gray-400 hover:text-white transition-colors">Événements</a></li>
              <li><a href="/search" className="text-gray-400 hover:text-white transition-colors">Recherche</a></li>
              <li><a href="/cart" className="text-gray-400 hover:text-white transition-colors">Panier</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Politique de Remboursement</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Inscrivez-vous pour recevoir nos dernières offres et événements.</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-gray-400 text-center">
          <p>&copy; {new Date().getFullYear()} Ticket Time. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
